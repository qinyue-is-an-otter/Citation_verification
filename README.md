...
### Tutorial
All you need to do is to modify the `pipeline_config.json` file to provide the evaluation parameters. Of course, if you wish to use `dois` mode, make sure you have your own key for the PMC database (it's free). We have two modes of citation evaluations. 
```json
{
